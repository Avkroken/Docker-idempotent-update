...
Säkerhetsalerts hanteras centralt av organisationens Skvallerbyttan-flöde. GitHubs inbyggda Dependabot security updates och Copilot-agent ska användas först när de kan hantera alerten; endast återstående fall går via Skvallerbyttans centrala Codex-fallback. Repositoryt ska därför inte ha en egen Code Scanning-snapshot eller en egen Codex security-remediation-writer.
