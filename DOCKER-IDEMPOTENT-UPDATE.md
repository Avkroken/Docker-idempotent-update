...
Repository-specific instructions for `Avkroken/Docker-idempotent-update`. These instructions supplement the canonical Avkroken policy in `Avkroken/.github/AGENTS.md`.
